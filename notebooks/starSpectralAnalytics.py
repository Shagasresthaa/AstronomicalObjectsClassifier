...
df = pd.read_csv('data/processed/starSpectralNoiseReducedData/1237645942906028124_spectra_denoised.csv')  # Update with your CSV file path
...
flux = df['flux']
smoothed_flux = df['smoothed_flux']
